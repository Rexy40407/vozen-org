...
assert.match(script, /sessionStorage\.getItem\('vh_session_bearer'\)/);
assert.match(script, /Authorization: `Bearer \$\{sessionBearer\}`/);
assert.match(script, /sessionStorage\.removeItem\('vh_session_bearer'\)/);
