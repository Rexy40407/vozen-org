...
const criticalLatinFont = fs.readFileSync(
  path.join(siteRoot, 'assets', 'fonts', 'unbounded-critical-latin.woff2'),
).toString('base64');
const pages = {
  home: {
...
const criticalFontCss = (navCss.match(/@font-face\s*\{[^}]*\}/g) || [])
  .join('\n')
  .replace(
    '../assets/fonts/unbounded-critical-latin.woff2',
    `data:font/woff2;base64,${criticalLatinFont}`,
  );
