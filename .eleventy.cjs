...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${helperRoot}assets/docs.css?v=ecosystem-nav-v5">
    <link rel="stylesheet" href="${docsRoot}shared/docs-shell.css?v=ecosystem-nav-v5">
  </head>
  <body data-docs-product="helper">
    ...
    <script src="${docsRoot}shared/docs-shell.js?v=ecosystem-nav-v5"></script>
    <script src="${siteRoot}js/global-nav-v1.js?v=ecosystem-nav-v5"></script>
  </body>
</html>`;
  });
  return {
