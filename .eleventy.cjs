...
module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addTransform('vozen-helper-shell', function (content) {
    ...
    return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="description" content="${description}"><link rel="canonical" href="https://vozen.org${this.page.url || '/docs/helper/'}"><title>${title} - Vozen Helper</title><link rel="stylesheet" href="/docs/helper/assets/docs.css"></head><body><a class="skip-link" href="#main">Skip to content</a><header class="docs-header"><a class="brand" href="/docs/helper/">Vozen <span>Helper</span></a><nav aria-label="Primary"><a href="/docs/helper/get-started/quick-setup/">Quick Setup</a><a href="/docs/helper/modules/">Modules</a><a href="/docs/helper/guides/protect-a-server/">Guides</a><a href="/docs/helper/reference/commands/">Reference</a><a href="/docs/helper/troubleshooting/bot-not-responding/">Troubleshooting</a></nav><form class="search-form" action="/docs/helper/" role="search"><label class="sr-only" for="docs-search">Search documentation</label><input id="docs-search" name="q" type="search" placeholder="Search docs" autocomplete="off"><div id="search-results" class="search-results" aria-live="polite"></div></form></header><main id="main" class="docs-main">${content}</main><footer class="docs-footer"><span>Vozen Helper documentation</span><span><a href="/privacy.html">Privacy</a> - <a href="/terms.html">Terms</a></span></footer><script src="/docs/helper/assets/minisearch.min.js"></script><script src="/docs/helper/assets/docs.js"></script></body></html>`;
  });
  return {
